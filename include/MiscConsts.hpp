...
{
	switch (id) {
		case 107:	return TYPE_OSCILL_SINUS;
		case 232:	return TYPE_OSCILL_SQUARE;
		case 494:	return TYPE_OSCILL_TRIANGLE;
		case 553:	return TYPE_OSCILL_SAW;
		case 619:	return TYPE_OSCILL_IMPULSE;

		case 824:	return TYPE_EFFECT_NOISE;

		case 827:	return TYPE_FILTER_COLOR;

		default:	return TYPE_OSCILL_SINUS;
	}
}
